...
def launch(pa, pg_resume=None, render=False, repre='image', end='no_new_job'):
	...
	with open ('/home/temp_siplab/shanka/temporary/rl_sudoku/sudoku4_trainx_easy_med.pkl', 'rb') as fp:
		X = pickle.load(fp)
	with open ('/home/temp_siplab/shanka/temporary/rl_sudoku/sudoku4_trainy_easy_med.pkl', 'rb') as fp:
	...
	for epoch in range(pa.num_su_epochs):
		...
		print("Epoch {} of {} took {:.3f}s".format(
			epoch + 1, pa.num_su_epochs, time.time() - start_time))
		...
		if epoch % pa.output_freq == 0:
			...
			net_file = open(pa.output_filename + '4x4_easy_med_'+str(epoch) + '.pkl', 'wb')
